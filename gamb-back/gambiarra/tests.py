...
class ChamadoModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.professor = Usuario.objects.create(username='professor1', email='prof@example.com')
        self.bolsista = Usuario.objects.create(username='bolsista1', email='bolsista@example.com')
        self.cliente = Usuario.objects.create(username='cliente1', email='cliente@example.com')
    ...
    def test_chamado_str(self):
        ...
        """
        self.assertEqual(str(self.chamado), f"Chamado Teste de Chamado - {self.chamado.status}")
    ...
    def test_status_default(self):
        ...
        """
        self.assertEqual(self.chamado.status, "1") # Assuming '1' is the default status code
    ...
    def test_campo_acessorio_opcional(self):
        ...
        new_item_for_optional_test = Item.objects.create(modelo='Item para Teste Opcional')
    ...
    def test_campo_titulo_max_length(self):
        ...
        with self.assertRaisesMessage(ValidationError, "O título pode conter no máximo 50 caracteres"):
    ...
    def test_campo_acessorio_max_length(self):
        ...
        with self.assertRaisesMessage(ValidationError, "O acessório pode conter no máximo 255 caracteres"):
    ...
    def test_campo_descricao_max_length(self):
        ...
        """
        long_description = "a" * 256 # More than 255 characters (adjusted to match model's max_length=255)
        with self.assertRaisesMessage(ValidationError, "A descrição pode conter no máximo 255 caracteres"):
            # Create a new item for this test
    ...
    def test_campo_titulo_obrigatorio(self):
        ...
        with self.assertRaisesMessage(ValidationError, "O título é obrigatório"):
            item_for_missing_title = Item.objects.create(modelo='Item para Titulo Ausente')
            Chamado.objects.create(
    ...
    def test_campo_descricao_obrigatoria(self):
        ...
        with self.assertRaisesMessage(ValidationError, "A descrição é obrigatória"):
            item_for_missing_desc = Item.objects.create(modelo='Item para Descricao Ausente')
            Chamado.objects.create(
